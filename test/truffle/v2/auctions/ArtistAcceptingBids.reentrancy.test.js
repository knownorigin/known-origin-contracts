...
contract('ArtistAcceptingBids - re-entrency tests', function (accounts) {
  ...
  describe('withdrawBid() - testing for re-entrancy', async () => {
    ...
    it('total balance shows for both edition 1 & 2', async () => {
    ...
    it('attacker contract has balance', async () => {
    ...
    it('edition 1 bid has been placed, attack contract is the winner', async () => {
    ...
    it('edition 2 bid has been placed', async () => {
    ...
    it('attempt hack - can withdraw more ether than placed in', async () => {
      /*
