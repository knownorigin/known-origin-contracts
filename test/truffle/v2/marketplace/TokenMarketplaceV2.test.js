...
contract.only('TokenMarketplaceV2 tests', function (accounts) {
  ...
  beforeEach(async () => {
    ...
    this.marketplace = await TokenMarketplaceV2.new(this.koda.address, _owner, {from: _owner});
      ...
      describe('and then being out bid', async () => {
        ...
        describe('then the owner accepts the bid', async () => {
          ...
          beforeEach(async () => {
            ...
            let tx = await this.marketplace.acceptBid(_1_token1, this.newBidAmount, {from: owner1});
