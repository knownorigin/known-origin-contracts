...
contract('SelfServiceEditionCurationV3 tests', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    // Create Minter
    this.minter = await SelfServiceEditionCurationV3.new(this.koda.address, this.auction.address, this.accessControls.address, {from: _owner});
